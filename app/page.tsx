  ...
  return (
    <div className="relative overflow-x-hidden">
      <main className="container mx-auto px-4 py-8 m-5">
        ...
        <section id="start" className="flex flex-col items-center text-center my-20">
        ...
        */}
        ...
        <section id="contact" className="flex items-center justify-around w-full mt-30">
...
const ServiceCard = ({ icon, title, description }: ServiceCardProps) => (
  <div className="max-w-lg bg-white md:bg-transparent p-6 md:p-0 rounded-lg md:shadow-none md:hover:shadow-none shadow-md hover:shadow-lg transition duration-300 flex items-center">
    <div className="text-[#fffcf7] bg-[#ff920f] w-fit h-fit p-3 rounded-full mr-5">{icon}</div>
    <div>
